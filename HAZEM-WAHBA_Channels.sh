...
wget -O /var/volatile/tmp/$channel-$"version".tar.gz "https://raw.githubusercontent.com/Ham-ahmed/108/refs/heads/main/channels_backup_OpenBlackhole_20250810_HAZEMWAHBA-CIEFP.tar.gz"
